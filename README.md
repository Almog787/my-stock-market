...
**Last Update / עדכון אחרון:** 20/02/2026 18:18 | **USD/ILS:** ₪3.115

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,457` | **שווי תיק** |
| **Daily Change** | `+1.49%` (₪2,669) | **שינוי יומי** |
| **Total Return** | `+38.37%` (₪50,315) | **תשואה מצטברת** |
