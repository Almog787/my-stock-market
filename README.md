...
**Last Update / עדכון אחרון:** 24/02/2026 16:37 | **USD/ILS:** ₪3.119

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪178,847` | **שווי תיק** |
| **Daily Change** | `-1.71%` (₪-3,111) | **שינוי יומי** |
| **Total Return** | `+36.20%` (₪47,537) | **תשואה מצטברת** |
