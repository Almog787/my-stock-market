...
**Last Update / עדכון אחרון:** 20/02/2026 16:44 | **USD/ILS:** ₪3.112

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,082` | **שווי תיק** |
| **Daily Change** | `+0.56%` (₪1,010) | **שינוי יומי** |
| **Total Return** | `+37.43%` (₪49,045) | **תשואה מצטברת** |
