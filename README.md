...
**Last Update / עדכון אחרון:** 24/02/2026 16:40 | **USD/ILS:** ₪3.112

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪179,492` | **שווי תיק** |
| **Daily Change** | `-1.14%` (₪-2,069) | **שינוי יומי** |
| **Total Return** | `+36.99%` (₪48,468) | **תשואה מצטברת** |
