...
**Last Update / עדכון אחרון:** 24/02/2026 16:56 | **USD/ILS:** ₪3.107

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪179,388` | **שווי תיק** |
| **Daily Change** | `-1.21%` (₪-2,199) | **שינוי יומי** |
| **Total Return** | `+37.15%` (₪48,587) | **תשואה מצטברת** |
