...
**Last Update / עדכון אחרון:** 23/02/2026 19:05 | **USD/ILS:** ₪3.118

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,645` | **שווי תיק** |
| **Daily Change** | `-0.70%` (₪-1,278) | **שינוי יומי** |
| **Total Return** | `+37.60%` (₪49,360) | **תשואה מצטברת** |
