...
**Last Update / עדכון אחרון:** 25/02/2026 00:39 | **USD/ILS:** ₪3.105

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,158` | **שווי תיק** |
| **Daily Change** | `+0.66%` (₪1,195) | **שינוי יומי** |
| **Total Return** | `+38.56%` (₪50,416) | **תשואה מצטברת** |
