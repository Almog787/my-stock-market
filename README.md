...
**Last Update / עדכון אחרון:** 24/02/2026 21:50 | **USD/ILS:** ₪3.107

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,181` | **שווי תיק** |
| **Daily Change** | `+0.82%` (₪1,469) | **שינוי יומי** |
| **Total Return** | `+38.52%` (₪50,380) | **תשואה מצטברת** |
