...
**Last Update / עדכון אחרון:** 24/02/2026 22:43 | **USD/ILS:** ₪3.103

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,046` | **שווי תיק** |
| **Daily Change** | `+0.87%` (₪1,559) | **שינוי יומי** |
| **Total Return** | `+38.59%` (₪50,409) | **תשואה מצטברת** |
