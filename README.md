...
**Last Update / עדכון אחרון:** 25/02/2026 23:40 | **USD/ILS:** ₪3.086

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪182,087` | **שווי תיק** |
| **Daily Change** | `+1.14%` (₪2,050) | **שינוי יומי** |
| **Total Return** | `+40.17%` (₪52,178) | **תשואה מצטברת** |
