...
**Last Update / עדכון אחרון:** 25/02/2026 18:12 | **USD/ILS:** ₪3.089

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,487` | **שווי תיק** |
| **Daily Change** | `+1.07%` (₪1,925) | **שינוי יומי** |
| **Total Return** | `+39.54%` (₪51,427) | **תשואה מצטברת** |
