...
**Last Update / עדכון אחרון:** 20/02/2026 19:42 | **USD/ILS:** ₪3.120

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,209` | **שווי תיק** |
| **Daily Change** | `+1.18%` (₪2,117) | **שינוי יומי** |
| **Total Return** | `+37.94%` (₪49,844) | **תשואה מצטברת** |
