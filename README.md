...
**Last Update / עדכון אחרון:** 25/02/2026 16:56 | **USD/ILS:** ₪3.092

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪182,407` | **שווי תיק** |
| **Daily Change** | `+2.17%` (₪3,868) | **שינוי יומי** |
| **Total Return** | `+40.12%` (₪52,225) | **תשואה מצטברת** |
