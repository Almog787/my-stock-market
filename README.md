...
**Last Update / עדכון אחרון:** 24/02/2026 18:06 | **USD/ILS:** ₪3.099

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,150` | **שווי תיק** |
| **Daily Change** | `+0.13%` (₪235) | **שינוי יומי** |
| **Total Return** | `+38.06%` (₪49,664) | **תשואה מצטברת** |
