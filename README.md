...
**Last Update / עדכון אחרון:** 25/02/2026 08:52 | **USD/ILS:** ₪3.099

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,796` | **שווי תיק** |
| **Daily Change** | `+0.66%` (₪1,193) | **שינוי יומי** |
| **Total Return** | `+38.56%` (₪50,315) | **תשואה מצטברת** |
