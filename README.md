...
**Last Update / עדכון אחרון:** 25/02/2026 22:42 | **USD/ILS:** ₪3.084

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,971` | **שווי תיק** |
| **Daily Change** | `+1.14%` (₪2,042) | **שינוי יומי** |
| **Total Return** | `+40.14%` (₪52,125) | **תשואה מצטברת** |
