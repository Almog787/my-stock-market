...
**Last Update / עדכון אחרון:** 24/02/2026 16:44 | **USD/ILS:** ₪3.110

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪179,677` | **שווי תיק** |
| **Daily Change** | `-0.98%` (₪-1,774) | **שינוי יומי** |
| **Total Return** | `+37.22%` (₪48,732) | **תשואה מצטברת** |
