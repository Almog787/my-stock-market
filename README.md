...
**Last Update / עדכון אחרון:** 23/02/2026 21:12 | **USD/ILS:** ₪3.122

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,615` | **שווי תיק** |
| **Daily Change** | `-0.85%` (₪-1,547) | **שינוי יומי** |
| **Total Return** | `+37.39%` (₪49,157) | **תשואה מצטברת** |
