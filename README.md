...
**Last Update / עדכון אחרון:** 20/02/2026 22:39 | **USD/ILS:** ₪3.116

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,667` | **שווי תיק** |
| **Daily Change** | `+1.66%` (₪2,965) | **שינוי יומי** |
| **Total Return** | `+38.48%` (₪50,483) | **תשואה מצטברת** |
