...
**Last Update / עדכון אחרון:** 20/02/2026 23:31 | **USD/ILS:** ₪3.113

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,614` | **שווי תיק** |
| **Daily Change** | `+1.55%` (₪2,764) | **שינוי יומי** |
| **Total Return** | `+38.57%` (₪50,552) | **תשואה מצטברת** |
