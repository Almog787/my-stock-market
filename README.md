...
**Last Update / עדכון אחרון:** 24/02/2026 22:26 | **USD/ILS:** ₪3.105

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,148` | **שווי תיק** |
| **Daily Change** | `+0.86%` (₪1,539) | **שינוי יומי** |
| **Total Return** | `+38.57%` (₪50,422) | **תשואה מצטברת** |
