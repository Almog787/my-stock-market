...
**Last Update / עדכון אחרון:** 23/02/2026 17:53 | **USD/ILS:** ₪3.119

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,076` | **שווי תיק** |
| **Daily Change** | `-0.50%` (₪-906) | **שינוי יומי** |
| **Total Return** | `+37.88%` (₪49,748) | **תשואה מצטברת** |
