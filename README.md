...
**Last Update / עדכון אחרון:** 20/02/2026 20:57 | **USD/ILS:** ₪3.115

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,916` | **שווי תיק** |
| **Daily Change** | `+1.74%` (₪3,105) | **שינוי יומי** |
| **Total Return** | `+38.70%` (₪50,757) | **תשואה מצטברת** |
