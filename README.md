...
**Last Update / עדכון אחרון:** 23/02/2026 23:53 | **USD/ILS:** ₪3.121

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,890` | **שווי תיק** |
| **Daily Change** | `-0.67%` (₪-1,214) | **שינוי יומי** |
| **Total Return** | `+37.65%` (₪49,475) | **תשואה מצטברת** |
