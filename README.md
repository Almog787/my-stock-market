...
**Last Update / עדכון אחרון:** 24/02/2026 19:22 | **USD/ILS:** ₪3.103

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,859` | **שווי תיק** |
| **Daily Change** | `+0.59%` (₪1,066) | **שינוי יומי** |
| **Total Return** | `+38.41%` (₪50,193) | **תשואה מצטברת** |
