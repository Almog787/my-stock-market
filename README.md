...
**Last Update / עדכון אחרון:** 24/02/2026 20:00 | **USD/ILS:** ₪3.104

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪180,752` | **שווי תיק** |
| **Daily Change** | `+0.51%` (₪918) | **שינוי יומי** |
| **Total Return** | `+38.30%` (₪50,056) | **תשואה מצטברת** |
