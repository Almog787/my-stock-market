...
**Last Update / עדכון אחרון:** 23/02/2026 16:54 | **USD/ILS:** ₪3.113

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,955` | **שווי תיק** |
| **Daily Change** | `+0.18%` (₪335) | **שינוי יומי** |
| **Total Return** | `+38.83%` (₪50,888) | **תשואה מצטברת** |
