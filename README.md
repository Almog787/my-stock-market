...
**Last Update / עדכון אחרון:** 24/02/2026 16:36 | **USD/ILS:** ₪3.118

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪179,286` | **שווי תיק** |
| **Daily Change** | `-1.43%` (₪-2,607) | **שינוי יומי** |
| **Total Return** | `+36.58%` (₪48,022) | **תשואה מצטברת** |
