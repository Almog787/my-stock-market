...
**Last Update / עדכון אחרון:** 24/02/2026 23:41 | **USD/ILS:** ₪3.105

## 💰 Performance Summary | סיכום ביצועים
| Metric | Value | נתון |
| :--- | :--- | :--- |
| **Portfolio Value** | `₪181,140` | **שווי תיק** |
| **Daily Change** | `+0.93%` (₪1,674) | **שינוי יומי** |
| **Total Return** | `+38.56%` (₪50,411) | **תשואה מצטברת** |
